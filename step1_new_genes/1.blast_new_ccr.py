...
def main():
    ...
    for genome in os.listdir(args.path_input_genome):
        ...
        mec_genes = ['ccrA1', 'ccrA2', 'ccrA3', 'ccrA4', 'ccrA5', 'ccrA7', 'ccrAm1',
                     'ccrB1', 'ccrB2', 'ccrB3', 'ccrB4', 'ccrB5', 'ccrB6', 'ccrB7', 'ccrBm1',
                     'ccrC1_1', 'ccrC1_10', 'ccrC1_2', 'ccrC1_3', 'ccrC1_4', 'ccrC1_5', 'ccrC1_6',
                     'ccrC1_7', 'ccrC1_8', 'ccrC1_9', 'ccrC2']
